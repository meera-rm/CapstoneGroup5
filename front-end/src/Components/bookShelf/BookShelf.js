      ...
      <div className='bookshelf'>
        <Link to='/books/level'>
          <div class='bookshelfContainer'>
            ...
            <div class='bookshelfbook bookshelfbook-green'>
              <h2 className='heading2'>Shapes we Eat</h2>
            </div>
            <div class='bookshelfbook bookshelfbook-springer'>
              <h2 className='heading2'>Colored shirts</h2>
            </div>
            <div class='bookshelfbook bookshelfbook-green '>
              <h2 className='heading2'>Want is not Need</h2>
            </div>
            <div class='bookshelfbook bookshelfbook-umber'>
              <h2 className='heading2'>In a Grocery Store</h2>
            </div>
           {/* <div class='bookshelfbook-tilted'>  */}
            <div class='bookshelfbook bookshelfbook-purple'>
              <h2 className='heading2'>Solids are interesting</h2>
            </div>
            {/* </div> */}
            <div class='bookshelfbook bookshelfbook-orange bookshelfbook-mobile'>
              <h2 className='heading2'>Introducing Arkansas</h2>
            </div>
            <div class='bookshelfbook bookshelfbook-blue bookshelfbook-mobile'>
        ...
        <Link to='/books/casual'>
          <div class='bookshelfContainer'>
            ...
            <div class='bookshelfbook bookshelfbook-umber bookshelfbook-mobile'>
              <h2>Danny and Bella</h2>
              <h3>Love to play</h3>
            </div>
            <div class='bookshelfbook bookshelfbook-blue'>
              <h2 className='heading2'>Bear Facts Vol.2</h2>
            </div>
            <div class='bookshelfbook bookshelfbook-imperial bookshelfbook-mobile'>
              <h2 className='heading2'>Looking At Reptiles</h2>
            </div>
            <div class='bookshelfbook bookshelfbook-deeppink'>
